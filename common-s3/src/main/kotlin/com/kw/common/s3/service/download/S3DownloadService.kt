package com.kw.common.s3.service.download

import com.amazonaws.AmazonServiceException
import com.amazonaws.SdkClientException
import com.amazonaws.services.s3.AmazonS3
import com.amazonaws.services.s3.model.GetObjectRequest
import com.kw.common.s3.dto.download.S3DownloadRequest
import com.kw.common.s3.dto.download.S3DownloadResult
...
class S3DownloadService(private val s3Client: AmazonS3) {
    ...
    fun downloadFile(downloadRequest: S3DownloadRequest): S3DownloadResult =
        try {
            ...
            logger.error(
                """
                    AWS S3 Download Error:
                        ...
                        - Description: {}
                """.trimIndent(),
                downloadRequest.bucket, downloadRequest.key, ex.errorMessage
            )
            null
            ...
            .let {
                S3DownloadResult(downloadRequest.bucket, downloadRequest.key, it != null)
            }
}
